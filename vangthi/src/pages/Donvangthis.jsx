...
const Donvangthis = () => {
    ...
    const shouldShowLyDoTuChoi = (donVangThiData) => {
        return donVangThiData?.TRANG_THAI === 'Từ Chối';
    };
    ...
    return (
        <div>
            ...
            {shouldShowLyDoTuChoi(donVangThiData) && donVangThiData?.LY_DO_TU_CHOI && (
                    ...
                    <div className="card">
                        <div className="card__body">
                            <Table
                                ...
                                bodyData={donVangThiData.Lich_This}
